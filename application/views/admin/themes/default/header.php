        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?= base_url('admin/dashboard') ?>">Welcome <?=$this->logged_in_name?> | Sales Portal</a>
                </div>
                <!-- /.navbar-header -->
                ...
                <div class="navbar-default sidebar" role="navigation">
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu">
                            ...
                            <li><a href="<?= base_url('admin/addresses') ?>"><i class="fa fa-table fa-fw"></i> Addresses</a></li>
                            <li><a href="<?= base_url('admin/notifications') ?>"><i class="fa fa-table fa-fw"></i> Push Notifications</a></li>


                            <?php if ($this->is_admin): ?>
                                <li><a href="<?= base_url('admin/establishment') ?>"><i class="fa fa-edit fa-fw"></i> Establishments</a></li>
                            ...
                            <?php endif; ?>
                            <?php if ($this->is_partner): ?>
                              <li><a href="<?= base_url('admin/establishment') ?>"><i class="fa fa-edit fa-fw"></i> My establishments</a></li>
                            <?php endif; ?>
                        </ul>
                    </div>
                    <!-- /.sidebar-collapse -->
